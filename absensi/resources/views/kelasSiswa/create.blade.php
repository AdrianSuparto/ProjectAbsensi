        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-description">Isi data nama kelas di bawah ini.</p>

                    <form class="forms-sample" method="POST" action="{{ route('kelasSiswa.store') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama" id="nama"
                                    placeholder="Nama Kelas" value="{{ old('nama') }}">
                                @error('nama')
